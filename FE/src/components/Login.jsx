      ...
      <div className="w-full max-w-sm mx-auto bg-[#FAFDFF] shadow-md rounded px-8 pt-6 pb-8 mb-5">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex justify-center">
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold px-8 py-2 rounded-sm focus:outline-none w-full text-center flex items-center justify-center">

...
const Banner = () => {
  return (
    <div className="lg:min-h-screen flex flex-col md:flex-row-reverse justify-between items-center gap-12 lg:gap-20 mt-20 lg:mt-0">
      {/* right side */}
      <motion.div
        className="md:w-1/2 w-full flex items-center md:justify-center"
